...
/* ------------------------------------------------------------------ */
const GRADIENT = "bg-gradient-to-r from-violet-600 to-purple-500";
            ...
            <Reveal key={s.title} delay={i * 90}>
              ...
              >
                <div className="flex items-start justify-between">
                  <span className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-violet-50 to-purple-50 transition-colors group-hover:from-violet-100 group-hover:to-purple-100">
          ...
          {PILLARS.map((p, i) => {
            ...
            return (
              <Reveal key={p.title} delay={i * 100}>
                <div>
                  <span className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-violet-100 to-purple-100">
