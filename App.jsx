      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 lg:px-8">
        ...
        <div className="flex items-center gap-2">
          <a
            href="#contact"
            onClick={go("contact")}
            className={`hidden cursor-pointer rounded-full px-5 py-2.5 text-sm font-semibold text-white shadow-md shadow-violet-200 transition-all hover:shadow-lg hover:shadow-fuchsia-200 hover:brightness-105 sm:inline-block ${GRADIENT}`}
          >
            Get in touch
          </a>
          <button
...
function Hero() {
  ...
  return (
    ...
    >
      ...
      {/* Left column wider (~58%), right form column narrower (~42%) */}
      <div className="relative mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 px-5 py-14 md:grid-cols-[1.15fr_0.85fr] md:gap-12 lg:gap-16 lg:px-8 lg:py-24">
...
/* ------------------------------------------------------------------ */
/*  Requirements — what dMRV demands & how Emertech delivers           */
/* ------------------------------------------------------------------ */
const REQUIREMENTS = [
  {
    icon: Scale,
    title: "Credible baselines & additionality",
    req: "Reductions must be real, additional, and beyond business-as-usual.",
    sol: "Structured baseline templates and additionality tests aligned to leading carbon standards.",
  },
  {
    icon: Satellite,
    title: "Robust measurement",
    req: "Activity and emissions data captured from the field, sensors, and remote sensing.",
    sol: "Native IoT and satellite ingestion with automated validation and gap-flagging.",
  },
  {
    icon: Ruler,
    title: "Approved methodologies",
    req: "Registry-approved quantification with documented factors and uncertainty.",
    sol: "Built-in methodology library with transparent, reviewable calculation logic.",
  },
  {
    icon: LineChart,
    title: "Continuous monitoring & reporting",
    req: "Performance tracked over time and compiled into clear, reviewable reports.",
    sol: "Live dashboards and one-click, audit-ready report exports.",
  },
  {
    icon: ShieldCheck,
    title: "Independent verification",
    req: "Third-party auditors confirm claims against tamper-evident evidence.",
    sol: "Immutable audit trails and verifier-ready data rooms.",
  },
  {
    icon: BadgeCheck,
    title: "Registry & issuance integrity",
    req: "Credits serialized and protected against double-counting across registries.",
    sol: "Registry integrations with unique serialization and full traceability.",
  },
];

function Requirements() {
  return (
    <section id="requirements" className="scroll-mt-20 bg-white py-20 lg:py-28">
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <Reveal className="text-center">
          <Eyebrow>What dMRV requires</Eyebrow>
          <h2 className="mx-auto mt-4 max-w-2xl text-3xl font-extrabold tracking-tight text-slate-900 sm:text-4xl">
            Everything credible carbon claims demand
          </h2>
          <p className="mx-auto mt-4 max-w-xl text-base text-slate-500">
            From baseline to issuance, dMRV carries strict requirements at every stage.
            Emertech is built to meet each one.
          </p>
          <div className="mt-6 flex flex-wrap justify-center gap-2">
            <Pill>6 core requirements</Pill>
            <Pill>Standards-aligned</Pill>
          ...
          {REQUIREMENTS.map((r, i) => {
            ...
            return (
              <Reveal key={r.title} delay={i * 80}>
                <div className="flex h-full flex-col rounded-2xl border border-slate-100 bg-white p-6 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-violet-200 hover:shadow-lg hover:shadow-violet-100/60">
                  <span className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-violet-50 to-fuchsia-50">
                    <Icon className="h-6 w-6 text-violet-600" strokeWidth={2} />
                  </span>
                  ...
                  <div className="mt-4 flex items-start gap-2.5 rounded-xl bg-violet-50/70 p-3.5">
                    <CheckCircle2 className="mt-0.5 h-4 w-4 flex-shrink-0 text-violet-600" />
                    <div>
                      <p className="text-[10px] font-bold uppercase tracking-wider text-fuchsia-600">
                        How Emertech delivers
                      </p>
                      <p className="mt-0.5 text-sm leading-snug text-slate-700">{r.sol}</p>
                    </div>
                  </div>
                </div>
              </Reveal>
  ...
  return (
    <section id="why-emertech" className="scroll-mt-20 bg-slate-50/70 py-20 lg:py-28">
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        ...
        {/* feature grid (this is the section the old "Platform" link pointed to —
            kept in place, now without a nav button) */}
        <Reveal delay={150}>
          <div
            id="platform"
...
function Footer() {
  ...
  const contacts = [
    ...
    {
      icon: MapPin,
      text: "A 609, Shelton Sapphire, Sector 15, CBD Belapur, Navi Mumbai, Maharashtra - 400614",
    },
